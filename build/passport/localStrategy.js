...
passport_1.use(new LocalStrategy(function (username, password, cb) { return __awaiter(void 0, void 0, void 0, function () {
    var foundUser, match, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                match = _a.sent();
                if (!match) {
                    return [2 /*return*/, cb(null, false, { message: "Invalid credentials" })];
                }
                cb(null, foundUser);
                return [3 /*break*/, 4];
            case 3:
